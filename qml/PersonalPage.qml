...
Rectangle {
    ...
    property alias headPortrait: image.source
    property alias nickname: nickname.text
    property alias followerBut: followerButton
    property alias fanBut: fanButton

    //获得个人主页数据
    function getNetizenInfo() {
//        image.source = netizen["headportrait"]
        nickname.text = netizen["nickname"]
        manuscriptNumText.text = netizen["videos"].length
        fansNumText.text = netizen["fans"].length
        followerNumText.text = netizen["followers"].length
    }
        ...
        RowLayout {
            ...
            ToolButton {
                ...
                onClicked: {
                    ...
                    manuscriptPage.manuscripts = netizen["videos"]
            ...
            ToolButton {
                ...
                onClicked: {
                    mainPage.visible = false
                    myFriend.followers = netizen["followers"]
                    myFriend.getFollowers()
